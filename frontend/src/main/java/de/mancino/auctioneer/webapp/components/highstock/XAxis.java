...
public class XAxis extends JSObject implements Serializable {
    @JSIgnore
     ...
     * @return self
     */
    public XAxis alternateGridColor(Color alternateGridColor) {
     ...
     * @return self
     */
    public XAxis gridLineColor(Color gridLineColor) {
     ...
     * @return self
     */
    public XAxis gridLineDashStyle(String gridLineDashStyle) {
     ...
     * @return self
     */
    public XAxis gridLineWidth(String gridLineWidth) {
     ...
     * @return self
     */
    public XAxis lineColor(Color lineColor) {
     ...
     * @return self
     */
    public XAxis lineWidth(Integer lineWidth) {
     ...
     * @return self
     */
    public XAxis linkedTo(Integer linkedTo) {
     ...
     * @return self
     */
    public XAxis maxPadding(Integer maxPadding) {
     ...
     * @return self
     */
    public XAxis minPadding(Integer minPadding) {
     ...
     * @return self
     */
    public XAxis minRange(Integer minRange) {
     ...
     * @return self
     */
    public XAxis minTickInterval(Integer minTickInterval) {
     ...
     * @return self
     */
    public XAxis offset(Integer offset) {
        this.offset = offset;
        return this;
    }
     ...
     * @return self
     */
    public XAxis opposite(Boolean opposite) {
     ...
     * @return self
     */
    public XAxis ordinal(Boolean ordinal) {
     ...
     * @return self
     */
    public XAxis reversed(Boolean reversed) {
     ...
     * @return self
     */
    public XAxis showEmpty(Boolean showEmpty) {
     ...
     * @return self
     */
    public XAxis startOfWeek(Integer startOfWeek) {
     ...
     * @return self
     */
    public XAxis title(String title) {
