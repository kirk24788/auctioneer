...
public interface ArmoryCharacterBO extends Serializable {
    public ArmoryCharacter createArmoryCharacter(final CharacterName characterName, final RealmName realmName, Color color) throws ArmoryCharacterAlreadyExistingException;
